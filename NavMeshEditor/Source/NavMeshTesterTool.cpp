...
//    InputGeom *inGeom, const ToolArgs* args
//):
//    m_args(args),
//    m_sample(0),
//	m_navMesh(0),
...
//            printf("Pathfinding straight, time delta microseconds: %lu\n",
...
//                m_spos[0],m_spos[1],m_spos[2], m_epos[0],m_epos[1],m_epos[2]);
//            std::printf("poly start ref: %zu, poly end ref: %zu\n", m_startRef, m_endRef);
//            auto tp1 = std::chrono::steady_clock::now();
...
//    if (m_npolys && m_args)
//    {
//        auto it = m_args->find("display_path_refids");
//        if (it != m_args->end() && it->second == "1") {
//            for (int i = 0; i < m_npolys; ++i) {
