...
public:
	...
	bool init(int maxNodes, int hashSize);
	void clearState();
	void clear();
...
public:
	...
	bool init(int heapSize);
	inline void clearState() { m_size = 0; }
	void clear();
